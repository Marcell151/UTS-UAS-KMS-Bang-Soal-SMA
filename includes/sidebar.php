...
<aside id="sidebar" class="w-80 bg-white border-r border-gray-100 flex flex-col fixed lg:sticky top-0 h-screen shadow-sm z-50 transform -translate-x-full lg:translate-x-0 transition-all duration-300">
    ...
    <div class="flex-1 py-8 space-y-1 overflow-y-auto px-4">
        ...
        <p class="px-6 text-[10px] font-black text-gray-300 uppercase tracking-[0.2em] mt-8 mb-4">Master Data</p>
        <a href="teachers.php" class="flex items-center px-6 py-3.5 space-x-3 rounded-2xl transition-all duration-300 <?php echo $current_page == 'teachers.php' ? 'bg-[#003366] text-white shadow-lg shadow-blue-100' : 'text-gray-500 hover:bg-gray-50 hover:pl-8'; ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            <span class="text-sm font-bold">Personel Guru</span>
        </a>
        <?php endif; ?>

        <?php if (hasRoleId([ROLE_ADMIN_SISTEM])): ?>
        <p class="px-6 text-[10px] font-black text-gray-300 uppercase tracking-[0.2em] mt-8 mb-4">Sistem</p>
        <a href="users.php" class="flex items-center px-6 py-3.5 space-x-3 rounded-2xl transition-all duration-300 <?php echo $current_page == 'users.php' ? 'bg-[#003366] text-white shadow-lg shadow-blue-100' : 'text-gray-500 hover:bg-gray-50 hover:pl-8'; ?>">
            ...
            <span class="text-sm font-bold">Akun & Akses</span>
        </a>
        <?php endif; ?>
    </div>
