...
<aside class="w-80 bg-white border-r border-gray-100 flex flex-col sticky top-0 h-screen shadow-sm italic">
    ...
    <div class="flex-1 py-8 space-y-2 overflow-y-auto">
        ...
        <?php if (hasRole(['Guru', 'Admin Akademik', 'Kepala Sekolah', 'Administrator (TU)'])): ?>
        ...
        <?php if (hasRole(['Guru', 'Admin Akademik'])): ?>
        ...
        <?php if (hasRole(['Guru', 'Admin Akademik', 'Kepala Sekolah'])): ?>
        ...
        <?php if (hasRole(['Admin Akademik', 'Kepala Sekolah'])): ?>
        ...
        <?php if (hasRole(['Administrator (TU)'])): ?>
